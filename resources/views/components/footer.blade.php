<footer class="bg-zinc-900 text-white mt-[10%] relative z-[5]">
    <div class="container mx-auto px-6 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2 lg:col-span-1">
                <img src="assets/logo.png" alt="" class="w-full px-[25%] mb-[3%] lg:px-0 lg:mb-0">
    ...
    <div
        ...
        <div class=" space-x-4 mt-4 sm:mt-0 hidden md:flex">
            <!-- Social Icons -->
            <a href="#" class=" text-zinc-300 hover:text-white"><svg class="w-6 h-6" fill="currentColor"
